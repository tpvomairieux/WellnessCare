...
export default function HairLossTreatment(): React.JSX.Element {
  return (
        ...
        <div className="grid w-full items-center gap-14 lg:grid-cols-[1fr_0.9fr]">
          <div className="max-w-4xl pl-0 lg:pl-8">
            ...
            <h1 className="mt-4 text-[4rem] font-bold leading-tight text-sky-950">
              Support healthier-looking hair with personalized treatment.
            </h1>

            <p className="mt-6 text-[1.25rem] leading-9 text-slate-600">
              Wellness Care provides hair loss support designed around each
              patient’s needs. Treatment may support scalp health, circulation,
              and the conditions needed for stronger-looking hair growth.
            </p>
